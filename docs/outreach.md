...
**Install:** `.deb` from GitHub Releases; Docker Hub image + Helm on GHCR
(see [install-docker-helm.md](install-docker-helm.md)).
...
| https://github.com/redis/redis-py/issues/3560 | Client follows Sentinel; stale ads send writes to the old master |
